# -*- coding: utf-8 -*-
"""
Created on Fri Sep  9 20:23:29 2022

@author: Rakesh
"""
##Coding refence has been take from Github profile from Mr Shreyas (shreyas0123)
######################## problem1 ######################################

import pandas as pd

#load the dataset
diabetes_data = pd.read_csv("D:/DATA SCIENCE ASSIGNMENT/Datasets_ET/Diabeted_Ensemble.csv")
...
#load the dataset
tumor_data = pd.read_csv("D:/DATA SCIENCE ASSIGNMENT/Datasets_ET/Tumor_Ensemble.csv")
tumor_data.columns
...
##Evaluation on testing data with with hyperparameter#
...
##Intiating voting classifier#

voting = VotingClassifier([('KNN', learner_1),
                           ('Prc',learner_2),
                           ('SVM', learner_3)])

##ftiting clasifier into data#
voting.fit(x_train,y_train)
...
#loading dataset#
cocoa_data =  pd.read_excel('D:/DATA SCIENCE ASSIGNMENT/Datasets_ET/Coca_Rating_Ensemble.xlsx' )
...
import pandas as pd
pass_data = pd.read_excel("C:/Users/hp/Desktop/ensemble assi/Ensemble_Password_Strength.xlsx")
